...
class ScoreStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetScore = channel.unary_unary(
                '/Score/GetScore',
                request_serializer=services__pb2.ScoreRequest.SerializeToString,
...
def add_ScoreServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetScore': grpc.unary_unary_rpc_method_handler(
                    servicer.GetScore,
                    request_deserializer=services__pb2.ScoreRequest.FromString,
...
class Score(object):
    ...
    def GetScore(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Score/GetScore',
            services__pb2.ScoreRequest.SerializeToString,
